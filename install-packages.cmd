...
set cmd=python.exe -m pip list --no-color
echo.
echo %cmd%
%cmd%
...
set cmd=python.exe -m pip list --no-color --outdated
echo.
echo %cmd%
%cmd%
...
set cmd=python.exe -m pip install --no-color --compile --upgrade pip
echo.
echo %cmd%
%cmd%
set cmd=python.exe -m pip install --no-color --compile --upgrade setuptools wheel
echo.
echo %cmd%
%cmd%
...
set cmd=python.exe -m pip install --no-color --compile --upgrade-strategy eager --upgrade --requirement requirements.txt
echo.
echo %cmd%
%cmd%
